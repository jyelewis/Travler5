fw.Window = function(windowID, appID, appPID, windowGUI){
	this.appID = appID;
	this.id = windowID;
...
fw.Window.prototype.urlForResource = function(resourcePath){
	return '/app/' + this.appPID + '/w_' + this.id + '/' + encodeURIComponent(resourcePath);
};
